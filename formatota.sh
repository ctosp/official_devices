...
echo -e "${RED}./ ${BLUE}out/target/product/jason/ctosp_jason-9.0-20190422-01253-OFFICIAL.zip ${GRAY}help"
exit
fi
...
echo -e "${RED}         \x22website_url\x22${NC}:${BLUE}\x22https://ctosp.org\x22,";
echo -e "${RED}         \x22news_url\x22${NC}:${BLUE}\x22https://t.me/ctosp_feed\x22,";
